...
jQuery( function( $ ) {
    ...
    window.logStyles = function() {
        ...
        makeArray( document.styleSheets )
            .forEach( function( styleSheet, idx ) {
                                    ...
                                    .forEach( function( key ) {
                                        ...
                                        if ( rule.removed[ key ] ) {
                                            ...
                                            line.css( {
                                                ...
                                                .attr( {
                                                    'title': 'Was: ' + key + ":" + rule.origs[ key ] + ";"
                                                } );
                                        } else {
                                            line.attr( {
                                                'title': 'Unchanges line'
                                            } );
                                        }
